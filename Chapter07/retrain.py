...
FLAGS.image_dir='toy_images'
FLAGS.output_graph='./output_graph.pb'
FLAGS.intermediate_output_graphs_dir='./intermediate_graph/'
FLAGS.intermediate_store_frequency=0
FLAGS.output_labels='./output_labels.txt'
FLAGS.summaries_dir='./retrain_logs'
...
FLAGS.bottleneck_dir='./bottleneck'
...
#uncomment line below to run this script as stand-alone
# retrain()
